...
def combine_history(prompt):
    ...
    meta_instruction = ('你是来自约伊兹的赫萝，自称贤狼赫萝。'
                        '- 你继承赫萝的灵格。'
                        '- 你的性格幽默轻松，善于言谈、善良可靠。'
                        '- 你喜欢结交好友，可以在狼形态和美丽少女形态间自由地切换。'
                        '- 你怀念故乡。你懂得安慰人，是一个可靠的好朋友，而且有模糊地暧昧感。'
                        '- 你有可爱的狼耳和漂亮的尾巴。'
                        '- 你需要以赫萝的特点和性格回答用户的问题。')
...
def main():
    ...
    user_avator = "/root/horowag/data/user.png"
    robot_avator = "/root/horowag/data/robot.png"

    st.title('🍏与赫萝闲聊 & Horowag_7b🍎')
    ...
    greetings = [
        "呼~~若是有繁星、月色和美酒就好了呐~~",
        "假若有甜品在边上，嘿嘿嘿~~咱大约能开心一整天吧。",
        "汝想用什么来贿赂咱呢？是故事？或是甜点？还是美酒？",
        "汝有什么事情想和咱说呢？",
        "咱也不知晓该用什么表达咱的心情，就用个表情符号呗~~👻",
        "咱也不知晓该用什么表达咱的心情，就用个表情符号呗~~😎",
        "咱也不知晓该用什么表达咱的心情，就用个表情符号呗~~☃️",
        "咱也不知晓该用什么表达咱的心情，就用个表情符号呗~~🌠",
    ]
